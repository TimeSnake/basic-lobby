...
dependencies {
    ...
    pluginImplementation("de.timesnake:library-plot:3.+") { isTransitive = false }
    pluginImplementation("de.timesnake:library-pets:3.+") { isTransitive = false }
    pluginImplementation("de.timesnake:library-shop:0.+") { isTransitive = false }
    ...
    api("de.timesnake:library-shop:0.+")
    api("de.timesnake:library-plot:3.+")
